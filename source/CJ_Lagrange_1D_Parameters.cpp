...
CJ_Lagrange_1D_Parameters::wall::w_type CJ_Lagrange_1D_Parameters::interp_wall_type(std::string_view str) const
{
...
CJ_Lagrange_1D_Parameters::ic_preset CJ_Lagrange_1D_Parameters::interp_ic_preset(std::string_view str) const
{
...
void CJ_Lagrange_1D_Parameters::assign_read_value(const std::string& value, std::string_view key)
{
...
void CJ_Lagrange_1D_Parameters::assign_read_wall_value(const std::string &value, std::string_view key, const ums_w_hs<std::string, std::pair<std::string, void*>>& w_table, const int n)
{
	// std::stoi, stod requires for std::string, so passing value as std::string_view is meaningless i think
...
bool CJ_Lagrange_1D_Parameters::does_initialized_values_contain_all_w_vars(const int n, const ums_w_hs<std::string, std::pair<std::string, void*>>& w_table) const noexcept
{
	bool result = true;
...
std::string CJ_Lagrange_1D_Parameters::set_wall_properties(std::ifstream& fin, const int n)
{
...
bool CJ_Lagrange_1D_Parameters::are_all_wall_variables_initialized(const std::vector<int>& initialized) const noexcept
{
	bool result = true;
...
bool CJ_Lagrange_1D_Parameters::are_all_general_variables_initialized() const noexcept
{
	bool result = true;
...
CJ_Lagrange_1D_Parameters::CJ_Lagrange_1D_Parameters(std::ifstream fin)
{
	...
	else
	{
		...
		v_0 = sqrt(2.0 * (gamma - 1.0) / (gamma + 1.0) * Q);
		V_0 = 1.0 / rho_0;
		V_CJ = gamma / (gamma + 1.0) * V_0;
