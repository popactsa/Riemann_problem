...
public:
    ...
    {
        return static_cast<Solver_spec*>(this)
            ->apply_boundary_conditions_impl();
    }
    void solve_step()
    {
    ...
    // specify basic dummy file to write in case of emergency
    {
    ...
    bool start() { return static_cast<Solver_spec*>(this)->start_impl(); }
};
