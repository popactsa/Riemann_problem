...
private:
	...
	static inline unordered_map_w_shs<std::string_view, std::string_view> wall_properties_tbl
	{
		{"type", "w_type"},
		{"n_fict", "int"},
		{"P", "double"},
	...
	unordered_map_w_shs<std::string_view, std::tuple<std::string_view, OBJECT_GROUP, void*>> parsing_tbl
	{
...
public:
	...
	static std::tuple<std::string_view, OBJECT_GROUP, void*> get_object_variable_info_impl(std::string_view, const std::pair<OBJECT_GROUP, void*>&);
	static void assign_enum_variable_impl(std::string_view, std::string_view, void*);
	void initialize_dependent_variables_impl();
	inline std::set<void*>* get_initialized_variables_impl()
	{
		return &initialized_variables;
	}
	inline unordered_map_w_shs<std::string_view, std::tuple<std::string_view, OBJECT_GROUP, void*>>* get_parsing_tbl_impl()
	{
		return &parsing_tbl;
	}
};
