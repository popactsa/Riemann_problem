...
Parameters_Lagrange_1D::get_object_variable_info_impl(std::string_view object_variable_name, const std::pair<OBJECT_GROUP, void*>& object_info)
{
...
std::tuple<std::string_view, Parameters_common::OBJECT_GROUP, void*> 
Parameters_Lagrange_1D::get_WALL_object_variable_info(std::string_view object_variable_name, void* object_ptr)
{
	...
	std::string_view object_variable_type = wall_properties_tbl.find(object_variable_name)->second;
...
Parameters_Lagrange_1D::viscosity Parameters_Lagrange_1D::interp_viscosity(std::string_view variable_value)
{
	using enum Parameters_Lagrange_1D::viscosity;
	unordered_map_w_shs<std::string_view, Parameters_Lagrange_1D::viscosity> tbl
	{
		{"none", none},
		{"Neuman", Neuman},
		{"Latter", Latter},
...
Parameters_Lagrange_1D::ic_preset Parameters_Lagrange_1D::interp_ic_preset(std::string_view read_value)
{
	using enum Parameters_Lagrange_1D::ic_preset;
	unordered_map_w_shs<std::string_view, Parameters_Lagrange_1D::ic_preset> tbl
	{
		{"test1", test1},
		{"test2", test2},
		{"test3", test3},
...
Parameters_Lagrange_1D::wall::w_type Parameters_Lagrange_1D::interp_w_type(std::string_view read_value)
{
...
void Parameters_Lagrange_1D::assign_enum_variable_impl(std::string_view variable_type, std::string_view read_value, void* variable_ptr)
{
	if (!variable_type.compare("ic_preset"))
		*(static_cast<Parameters_Lagrange_1D::ic_preset*>(variable_ptr)) = interp_ic_preset(read_value);
	else if (!variable_type.compare("w_type"))
		*(static_cast<Parameters_Lagrange_1D::wall::w_type*>(variable_ptr)) = interp_w_type(read_value);
	else if (!variable_type.compare("viscosity"))
		*(static_cast<Parameters_Lagrange_1D::viscosity*>(variable_ptr)) = interp_viscosity(read_value);
}
